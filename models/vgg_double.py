...
class VGG(nn.Module):
    ...
    def __init__(self, cfg, batch_norm=False, num_classes=1000):
        ...
        self.block1 = self._make_layers(cfg[1], batch_norm, cfg[0][-1] * 2)
        self.block2 = self._make_layers(cfg[2], batch_norm, cfg[1][-1] * 2)
        self.block3 = self._make_layers(cfg[3], batch_norm, cfg[2][-1] * 2)
        self.block4 = self._make_layers(cfg[4], batch_norm, cfg[3][-1] * 2)
